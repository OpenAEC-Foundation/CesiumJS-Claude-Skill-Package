...
**Mission**: Build a complete, production-ready skill package for CesiumJS and publish it under the OpenAEC Foundation on GitHub. This is your standing order for every session in this workspace.
...
## Project Identity
- CesiumJS skill package for Claude — {{TECH_DESCRIPTION}}
...
gh repo create OpenAEC-Foundation/{{GITHUB_REPO_NAME}} --public \
  --description "Deterministic Claude skills for CesiumJS"
...
### Release:
```bash
git tag -a v1.0.0 -m "v1.0.0: X deterministic skills for CesiumJS"
git push origin v1.0.0
gh release create v1.0.0 --title "v1.0.0 — CesiumJS Skill Package" \
